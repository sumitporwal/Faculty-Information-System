...
public class SuperAdminController {
	 ...
	 public ModelAndView teacherDashboard(Model model,HttpSession session,Principal principal) {
		ModelAndView mv = new ModelAndView();
		 if(principal!=null) {
		     ...
		     mv.setViewName("Super_Admin/teacherdashboard");
	 ...
	 public ModelAndView studentDashboard(Model model,HttpSession session,Principal principal) {
		ModelAndView mv = new ModelAndView();
		 if(principal!=null) {
		     ...
		     mv.setViewName("Super_Admin/studentdashboard");
	 ...
	 public ModelAndView OwnProfile(Model model,HttpSession session,Principal principal) {
		ModelAndView mv = new ModelAndView();
		 if(principal!=null) {
		     ...
		     AdditionalUserDetails additional_user_details1=additionaluserdetails_service.findAdditionalUserDetailsById(user1.getUser_id());
		     model.addAttribute("additional_user_details1", additional_user_details1);
		     mv.setViewName("Super_Admin/ownprofile");
	 ...
	 public ModelAndView ViewProfile(Model model,HttpSession session,Principal principal,@PathVariable("id") long user_id) {
		ModelAndView mv = new ModelAndView();
		 if(principal!=null) {
		     ...
		     if(user2.getRoles().getRole_id()==1) {
		    	 mv.setViewName("Super_Admin/ownprofile");
		     }
		     else if(user2.getRoles().getRole_id()==2) {
		    	 mv.setViewName("Common/viewadminprofile");
		     }
	...
	@RequestMapping(value= {"/notifications"}, method=RequestMethod.GET)
	 ...
	 if(principal!=null) {
	     ...
	     AdditionalUserDetails additional_user_details1=additionaluserdetails_service.findAdditionalUserDetailsById(user1.getUser_id());
	     model.addAttribute("additional_user_details1", additional_user_details1);
	     if(notification_service.getNotificationList()==null || notification_service.getNotificationList().size()==0) {
	     ...
	     mv.setViewName("Super_Admin/notifications");
	...
	@RequestMapping(value= {"/bus"}, method=RequestMethod.GET)
	 ...
	 if(principal!=null) {
	     ...
	     mv.setViewName("Super_Admin/bus");
	...
	@RequestMapping(value= {"/leaveapplication"}, method=RequestMethod.GET)
	 ...
	 if(principal!=null) {
	     ...
	     AdditionalUserDetails additional_user_details1=additionaluserdetails_service.findAdditionalUserDetailsById(user1.getUser_id());
	     model.addAttribute("additional_user_details1", additional_user_details1);
	     if(leaveapplication_service.getLeaveApplicationList()==null || leaveapplication_service.getLeaveApplicationList().size()==0) {
	        model.addAttribute("leave_applications", "No Records Found");
	     }else {
		    model.addAttribute("leave_applications",leaveapplication_service.getLeaveApplicationList());
		 }
	     mv.setViewName("Super_Admin/leaveapplication");
	...
	@RequestMapping(value= {"/ownleaveapplication"}, method=RequestMethod.GET)
	 ...
	 if(principal!=null) {
	     ...
	     mv.setViewName("Super_Admin/ownleaveapplication");
	...
	@RequestMapping(value= {"/vacancy"}, method=RequestMethod.GET)
	 ...
	 if(principal!=null) {
	     ...
	     AdditionalUserDetails additional_user_details1=additionaluserdetails_service.findAdditionalUserDetailsById(user1.getUser_id());
	     model.addAttribute("additional_user_details1", additional_user_details1);
	     if(vacancy_service.getVacancyList()==null || vacancy_service.getVacancyList().size()==0) {
	        model.addAttribute("vacancies", "No Records Found");
	     }else {
		    model.addAttribute("vacancies",vacancy_service.getVacancyList());
		 }
	     mv.setViewName("Super_Admin/vacancy");
	...
	@RequestMapping(value= {"/vacancy/{id}"}, method=RequestMethod.GET)
	 ...
	 if(principal!=null) {
	     ...
	     mv.setViewName("Super_Admin/vacancyDescription");
	...
	@RequestMapping(value= {"/postedvacancy"}, method=RequestMethod.GET)
	 ...
	 if(principal!=null) {
	     ...
	     mv.setViewName("Super_Admin/postedVacancy");
	...
	@RequestMapping(value= {"vacancyapplicantDetails/{id}"}, method=RequestMethod.GET)
	 ...
	 if(principal!=null) {
	     ...
	     mv.setViewName("Super_Admin/vacancyapplicantDetails");
	...
	@RequestMapping(value= {"/referredvacancy"}, method=RequestMethod.GET)
	 ...
	 if(principal!=null) {
	     ...
	     mv.setViewName("Super_Admin/referredVacancy");
